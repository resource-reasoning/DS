...
\newcommand{\csat}[1][\como]{\triangleright_{#1}}
...
\newcommand{\toT}[1]{\rightarrow_{\halfMath{#1}}}
\newcommand{\toG}[1]{\Rightarrow_{\halfMath{#1}}}
