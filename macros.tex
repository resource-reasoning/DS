...
\newcommand{\mergeFP}[2]{\pred{\mrg_{\fph}}{#1,#2}}
\newcommand{\mopFP}{\mathbin{\mrg_{\fph}}}
\newcommand{\mergeVAL}[2]{\pred{\mrg_{\mathtt{V}}}{#1,#2}}
\newcommand{\mopVAL}{\mathbin{\mrg_{\scalebox{.5}{\(\mathtt{V}\)}}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Event tags
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\mergeA}[2]{\pred{\mrg_{\action}}{#1,#2}}
\newcommand{\mopA}{\mathbin{\mrg_{\action}}}
\newcommand{\mergeI}[2]{\pred{\mrg_{\scalebox{.5}{\(\intf\)}}}{#1,#2}}
\newcommand{\mopI}{\mathbin{\mrg_{\scalebox{.5}{\(\intf\)}}}}
\newcommand{\mclose}{^{\mrg}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Logical State
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
