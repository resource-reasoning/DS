...
\newcommand{\leval}[2]{\denote{#1}_{#2}}
...
\newcommand{\aeval}[2]{\denote{#1}_{#2}}

%model
\newcommand{\Kaps}{\sort{Kap}}
\newcommand{\kap}{\kappa}
\newcommand{\composeK}{\ensuremath{\bullet_{\kap}}}
\newcommand{\unitK}{\ensuremath{\mathbf{0}_{\kap}}}

\newcommand{\Caps}{\sort{Cap}}
\newcommand{\ca}{\ensuremath{\mathit c}}
\newcommand{\composeC}{\ensuremath{\bullet_{\ca}}}
\newcommand{\unitC}{\ensuremath{\mathbf{0}_{\ca}}}

\newcommand{\LStates}{\sort{LState}}
\newcommand{\ls}{\ensuremath{\mathit l}}
\newcommand{\lsFPH}[1]{\ensuremath{#1^{\mathsf{H}}}}
\newcommand{\lsCap}[1]{\ensuremath{#1^{\mathsf{C}}}}

\newcommand{\Heap}{\sort{Heap}}
\newcommand{\Stack}{\sort{Stack}}
\newcommand{\Timestamp}{\sort{TimeStamp}}
\newcommand{\Loc}{\sort{Addr}}
...
%\newcommand{\heapwithfingerprint}{\hat{tehh}}
...
\newcommand{\unitFP}{\ensuremath{\unitelem{\fph}}}
...
% Tada, this part is for david's project.
