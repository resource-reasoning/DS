...
\newcommand{\lpost}{q}
\newcommand{\lframe}{r}
\newcommand{\evalLS}[2][\lenv, \stk]{\llparenthesis{#2}\rrparenthesis_{#1}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% rely and guarantee
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\relyU}[1][\como]{\rely^{u}(#1)}
\newcommand{\relyE}[1][\como]{\rely^{e}(#1)}
\newcommand{\guarU}[1][\como]{\guar^{u}(#1)}
\newcommand{\guarE}[1][\como]{\guar^{e}(#1)}
\newcommand{\RelyI}[1][\como]{{\mathcal R}(#1)}
\newcommand{\GuarI}[1][\como]{{\mathcal G}(#1)}
