...
\newcommand{\mrg}[2]{\pred{\mergeName{#1}}{#2}}
...
\newcommand{\mopFP}{\mathbin{\mrgop_{\scalebox{.5}{\(\fph\)}}}}
\newcommand{\agreeFP}[2]{\agree{\scalebox{.5}{\(\fph\)}}{#1,#2}}
...
\newcommand{\mergeVAL}[2]{\mrg{\scalebox{.5}{\(\mathtt{V}\)}}{#1,#2}}
\newcommand{\mopVAL}{\mathbin{\mrgop_{\scalebox{.5}{\(\mathtt{V}\)}}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Event tags
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\mergeA}[2]{\mrg{\action}{#1,#2}}
\newcommand{\mopA}{\mathbin{\mrgop_{\action}}}
\newcommand{\mergeI}[2]{\mrg{\scalebox{.5}{\(\intf\)}}{#1,#2}}
\newcommand{\mopI}{\mathbin{\mrgop_{\scalebox{.5}{\(\intf\)}}}}
