...
\specialcomment{app}{\begingroup\color{light-gray}application related: }{\endgroup}
%\excludecomment{sx}
%\excludecomment{pg}
%\excludecomment{app}
...
\newcommand\SpaceAboveDef[1][-2pt]{\spaceshrink{#1}}
\newcommand\SpaceBelowDef[1][-2pt]{\spaceshrink{#1}}
\newcommand\SpaceAboveMath[1][-6pt]{\spaceshrink{#1}\displaymathfont}
\newcommand\SpaceBelowMath[1][-6pt]{\normalsize\spaceshrink{#1}}
