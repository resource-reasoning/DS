...
\cite{ramp,rola,cops,wren,redblue,PSI,NMSI,gdur,clocksi,distrsi}.\polish{Huge
  list of references again.} 
...
client. \polish{Notice that we've gone from client view to view here,
  I've done a fudge to make work.} 
...
\polish{Do we actually ever use configurations?}
...
\polish{Care, I find confusion between view snapshots and
  transactional snapshots, I think a reviewer mentioned this.. Note
  what I've done.}
...
\polish{Layout of figures could be a bit less squashed, sorry.}  
...
\polish{There's a quite subtle well-formedness issue, did you do in
  your thesis Hale, I can't rememebr. Boaz did recently for NewUpdate
  using a confluence arguement. At very least, say not difficult to
  show well-formed.} 
