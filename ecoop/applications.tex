...
client sessions. \polish{HAs anyone done anything like locks?} \polish{no}
...
But examples in \cite{bank,giovanni_concur16,snapshot-isolation-robust-tool}. 
