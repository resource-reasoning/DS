...
an ideal mid-point for both verifying distributed protocols 
...
consistency model.
An abstract state is a centralised, multi-versioned kv-store, which is \emph{global}:
...
(2) the other containing both versions of \(\key\) as depicted in \cref{fig:counter_kv_view_all}%
