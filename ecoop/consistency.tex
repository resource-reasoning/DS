...
to \(\vi'\). 
%\polish{Do we use this or is this historical: We adopt the notation \(\ET \vdash (\mkvs, \vi) \csat \fp: (\mkvs', \vi')\) to capture this intuition. }
...
\end{enumerate*}
With abstract executions, using the fact that there is a total order
...
\polish{Presumably, it's also because there's
...
%\polish{Goodness, this explanation
