...
Our semantics shares similar idea to log-based semantics \cite{log-based-op,push-pull}.
...
While our semantics is parametrised by an execution test which gives rise to 
