...
We assume that the version list for each key has an initial version 
...
The relation $\toLTS{\transpri}\; \subseteq (\Stacks \times \Snapshots)^{2}$ % \times (\Stacks \times \Snapshots)
