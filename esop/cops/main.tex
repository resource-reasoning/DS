In \cref{sec:applications}, we have explained the COPS protocol 
...
\subsubsection{Reference Machine States} \label{sec:cops-model} \input{cops/model} 
\subsubsection{Reference Operational Semantics} \label{sec:cops-semantics} \input{cops/semantics} 
\subsubsection{Normal Traces and Extended Traces} \label{sec:cops-normal-trace} \input{cops/normal-trace} 
\label{sec:cops-extended-trace} \input{cops/extended-trace} 
\subsubsection{Trace Refinement} \label{sec:cops-encode} \input{cops/encode} 
