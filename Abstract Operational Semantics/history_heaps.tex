...
\mathsf{HHupdate}_{\tsid}(\hh, V', \mathcal{O}) = \hh' \qquad \mathsf{ViewUpdate}(\hh, V', \mathcal{O}) \sqsubseteq V'' \qquad 
...
\ac{
I'm changing (again) the definition of consistency models. I'm leaving the old 
