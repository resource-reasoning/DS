...
%\]
\[
\infer[{\scriptstyle(Tx-exec)}]{\langle \hh, \thdstack, V, [\trans].\cmd \rangle \xrightarrow{CM} \langle \hh', \thdstack', V', \cmd \rangle}
{\begin{array}{c}
...
we often write $\cmd_1 \Par \cdots \cmd_n$ as a shorthand for $\tid_1: \cmd_1 \Par \cdots \Par
\tid_n: \cmd_n$. 
