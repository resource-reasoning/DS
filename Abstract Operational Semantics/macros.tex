...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% History Heap and cuts
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\HisHeaps}{\sort{HisHeap}}
...
\newcommand{\clpsHH}[1]{\func{clps}{#1}}
...
\newcommand{\fpE}{\scalebox{0.8}{\faPencil}\stackrel{\perp}{\hookrightarrow} \backslash}
...
\newcommand{\fpI}{\stackrel{\perp}{\hookrightarrow} \backslash}
