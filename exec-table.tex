...
{\small
\begin{align*}
	\rel_{\WFR} & \equiv \WR_{\mkvs} ; \SO\rflx \quad
	\rel_{\CC} \equiv \rel_{\WFR} \cup \SO \quad
	\rel_{\UA}(\fp) \equiv \bigcup_{(\otW, \key, \stub) \in \fp} \WW^{-1}_{\mkvs}(\key) \quad
	\rel_{\PSI}(\fp) \equiv \rel_{\CC} \cup \rel_{\UA}(\fp)\\
	\rel_{\CP} &\equiv \SO;\RW\rflx \cup \WR;\RW\rflx \cup \WW
	\quad
	\rel_{\SI}(\fp) \equiv \rel_{\CP} \cup \rel_{\UA}(\fp)
\end{align*}
%
%\begin{align*}
%    \WR_{\mkvs} &\defeq
