...
been proposed in the literature \cite{ev_principles,cops,redblue,redblue,PSI,clocksi}, which capture different trade-offs 
...
that correspond to a serial execution of transactions, where transactions only read the most up-to-date 
...
implementing \emph{eventual consistency} achieve very fast transaction processing, at the expenses 
