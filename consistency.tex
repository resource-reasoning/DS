...
&
\CP & \( \Set{(\mkvs, \vi, \fp, \mkvs', \vi')}[\pred{allowed}[\mkvs,\vi,\dagger]] \cap \ET_\MR \cap \ET_\RYW \) 
\\
\WFR & 
\( \pred{allowed}[\mkvs, \vi, \WR_{\mkvs} ; \SO\rflx] \)
&
$\SI$ & $\Set{(\mkvs, \vi, \fp, \mkvs', \vi')}[\pred{allowed}[\mkvs,\vi,\ddagger]] \cap \ET_\MR \cap \ET_\RYW  \cap \ET_\UA $
\\
