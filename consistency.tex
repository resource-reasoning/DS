...
must also be included in $\vi'$ on $\mkvs'$ (i.e. $\vi \sqsubseteq \vi'$), hence 
...
Causal consistency has been defined in the literature~\cite{session2causal,principle-eventual-consistency} 
...
In \cref{fig:wr-wfr-allowed-but-cc} we show that $\CMs[\ET_{\MW} \cap \ET_{\RYW}] \neq \CMs(\ET_{\MW+\WFR})$. 
...
\sx{I need to put an example in the appendix.}
