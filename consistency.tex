...
&
$\PSI$ & $\Set{(\mkvs, \vi, \fp, \mkvs', \vi')}[\allowed[\mkvs,\vi,(\SO \cup \WR_{\mkvs} \cup \WW_{\mkvs})]] \cap \ET_\MR \cap \ET_\RYW  \cap \ET_\UA $
\\
...
&
$\SI$ & $\Set{(\mkvs, \vi, \fp, \mkvs', \vi')}[\allowed[\mkvs,\vi,\dagger \cup (\WW_\mkvs; \RW_\mkvs\rflx)]] \cap \ET_\MR \cap \ET_\RYW  \cap \ET_\UA $
\\
$\CC$ & $\Set{(\mkvs, \vi, \fp, \mkvs', \vi')}[\allowed[\mkvs,\vi,\ddagger]] \cap \ET_\MR \cap \ET_\RYW$
&
