...
%with  the label \(\varepsilon\) denoting that there was no access to the kv-store; or  \(\cl\) 
%commits a transaction with the label \(\fp\)  denoting the fingerprint of the committed transaction.
...
comprises  tuples of the form \((\mkvs,\vi, \fp, \allowbreak \mkvs', \vi')\) 
