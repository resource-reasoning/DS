...
%\[
%\txid^{i} \xrightarrow{\SO_{\mkvs}} \txid^{i+1} \xrightarrow{(\SO_{\mkvs} \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \RW_{\mkvs})^{\ast}} 
%\txid^{j} \xrightarrow{\SO_{\mkvs}} \txid^{j+1} \xrightarrow{(\SO_{\mkvs} \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \RW_{\mkvs})^{\ast}} 
%\txid^{i}
%\]
