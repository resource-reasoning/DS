...
the relations $\PO_{\mkvs_{2}}, \WR_{\mkvs_{2}}, \WW_{\mkvs_{2}}, \AD_{\mkvs_{2}}$: 
...
%Recall that $\mkvs' \in \updateKV(\mkvs, \vienv(\cl), \cl, \{(\otR, \key, n), (\otW, \key, n+1)\}$. 
...
%Consider an arbitrary client $\cl'$. If $\cl' \neq \cl$, $\vienv'(\cl') = \vienv(\cl')$: if $\txid_{\cl'}^{m} \in \{\WTx(\mkvs'(\key, i))\} 
...
%of $\ET_{\MRd}$ and $\ET_{\RYW}$ imply that $\vienv'(\cl) = [\key \mapsto \{0,\cdots, n+1\}]$. 
...
%from the definition of $\ET_{\MRd}$ we also have that $\vienv(\cl) \viewleq \vienv'(\cl)$. 
...
%
%Because $\mkvs' = \updateKV(\mkvs, \vienv(\cl), \txid, \{(\otR, \key, n)\}$, 
...
We have proved that $\dashrightarrow$ is an irreflexive relation, and it contains $(\PO_{\mkvs} \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^+$; 
...
\[
\txid_{\cl_1}^{1} \xrightarrow{\PO_{\mkvs_4}} \txid_{\cl_1}^{2} \xrightarrow{\AD_{\mkvs_4}} \txid_{\cl_2}^{1} \xrightarrow{\PO_{\mkvs_4}} 
\txid_{\cl_2}^{2} \xrightarrow{\AD_{\mkvs_4}} \txid_{\cl_1}^{1}.
\]
...
Let $\mkvs \in \CM(\ET_{\SI})$. Then the relation $((\PO_{\mkvs} \cup \WR_{\mkvs} \cup \WW_{\mkvs}) ; \AD_{\mkvs}?)^{+}$ is 
...
such abstract execution $\aexec$, the relation $((\PO_{\mkvs} \cup \WR_{\mkvs} \cup \WW_{\mkvs}); \AD_{\mkvs}?)^{+}$ 
...
total order covers the relation $(\PO_{\mkvs} \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^{\ast}$. 
...
Furthermore, whenever $\txid \xrightarrow{\WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs}} \txid'$, it must be the case that 
$\txid \dashrightarrow \txid'$ (the same does not hold anymore in the case of $\txid \xrightarrow \txid'$, 
We also observe that whenever $\txid \twoheadrightarrow \txid'$, then it cannot be $\txid \xrightarrow{\WR \cup \WW \cup \AD} \txid'$, 
...
$\txid \twoheadrightarrow \txid'$. It follows that $(\PO_{\mkvs} \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^{+}$ 
...
We have determined that the presence of a cycle in the relation $(\PO_{\mkvs} \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^{+}$ 
...
%\[
%\txid^{i} \xrightarrow{\PO_{\mkvs}} \txid^{i+1} \xrightarrow{(\PO_{\mkvs} \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^{\ast}} 
%\txid^{j} \xrightarrow{\PO_{\mkvs}} \txid^{j+1} \xrightarrow{(\PO_{\mkvs} \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^{\ast}} 
%\txid^{i}
%\]
