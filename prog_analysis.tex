...
%can be manipulated via the $\ctr(\ke)$ and $\mathsf{read}(\ke)$ transactions, 
...
abstract executions that satisfy the axiomatic specification of $\SI$ (\cref{sec:sound-complete-si}), and the fact that for any 
