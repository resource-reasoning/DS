...
$\hh_{\aexec} = \aexec$. As we discuss later in this Section, this mapping 
...
For any abstract execution $\aexec$, $\aexec \compatible \hh_{\aexec}$.
\end{theorem}
...
$\getView(\aexec, \T) = \lambda \ke. \{ i \mid i \in [\lvert \hh_{\aexec} \rvert - 1] \wedge 
