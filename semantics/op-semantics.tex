...
\begin{array}{c}
 ...
 \end{array} 
\]
The syntax of commands in our programming language is roughly standard, 
exception made for the following: 
primitive commands that can be invoked by clients are split into transactional ones,
corresponding to the $\transpri$ clause \cref{fig:semantics},
...
for each key, the first read (before a write) and the last write. 
...
\subsubsection{Committing Transactions.}
