...
Specifically, we let $\txid \xrightarrow{\PO} \txid' \iff \exists \cl, n,m. \txid = \txid_{\cl}^{n} \wedge 
\txid' = \txid_{\cl}^{m} \wedge n < m$ to denote that client $\cl$ has executed $\txid$ prior to $\txid'$.
