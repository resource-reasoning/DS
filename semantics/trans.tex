...
\sx{Key-vaule store instead of heap. Address to key, value to natural number + key}
...
The arithmetic expression evaluation \( \evalE{\expr} \) is defined in \defref{def:language} and the \( \addO \) operator is in \defref{def:ops}.
