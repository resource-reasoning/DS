...
For all kv-stores $\mkvs$: $\mkvs \in \CMs(\ET_{\SER})$ iff $(\PO \cup \WR_{\mkvs} 
\cup \WW_{\mkvs} \cup \AD_{\mkvs})^{+}$ is irreflexive.
\end{theorem}
...
\begin{enumerate*}
	...
	\item show that the invariant implies the irreflexivity of $(\PO \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^{+}$.
\end{enumerate*}
...
and includes $\PO \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs}$. 
As such, $(\PO \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^+$ is irreflexive, 
...
\begin{theorem}
\label{thm:si_cycles}
For all $\mkvs \in \CMs(\ET_{\SI})$, any cycle in $(\PO \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^+$ has two adjacent $\AD_{\mkvs}$-edges.
\end{theorem}
...
we then know that $\rightarrow$ embeds $(\PO \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^{+}$.
...
However, this cannot happen in $\mkvs$, as otherwise we would have a cycle in $(\PO \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^{+}$ with no adjacent $\AD_{\mkvs}$-edges (a $\twoheadrightarrow$ edge represents two  $\PO_{\mkvs}$-related transactions, 
thus contradicting \cref{thm:si_cycles}). 
It then follows that $\rightarrow$ is irreflexive, and thus so is $(\PO \cup \WR_{\mkvs} \cup \WW_{\mkvs} \cup \AD_{\mkvs})^+$.
