...
we give the first robustness proof that take client sessions into account.
...
This is because execution graphs do not record the library \emph{state} and merely record the execution shape, thus making it harder to reason about such guarantees.
