...
\[
	\kappa \prec \mathcal{J} \iff \exists K \in \mathcal{P}(\mathbb{K}) \ldotp \kappa = \prod_{\kappa_i \in K}^{\bullet_\mathbb{K}} \kappa_i \land \forall \kappa_i \in K \ldotp \exists \kappa' \in \pred{dom}{\mathcal{J}} \ldotp \kappa_i \leq \kappa'
\]
