...
\[
	\mathsf{AMod} \triangleq \mathsf{Rid} \times \mathcal{P}(\mathbb{K}) \overset{\text{fin}}{\rightharpoonup} \mathcal{P}(\mathsf{Action})
\]
...
\\
	...
	\iff
	&
	l = \mathbf{0}_\mathbb{M} \text{ and } \exists s, r \ldotp g = s \circ r \text{ and } \\
	&& s, e \vDash_{g, \mathcal{J}} P \text{ and } \mathcal{J} \downarrow (s, r, \tsem{I}_e^\textsc{i})
\\
...
\\
	w, e \vDash \exists x \ldotp P \lor Q
	&
	\iff
	&
	w, e \vDash \exists x \ldotp P \text{ or } w, e \vDash \exists x \ldotp Q
\\
	w, e \vDash \exists x \ldotp P \sep Q
	&
	\iff
	&
	\exists w_1, w_2 \ldotp w = w_1 \bullet w_2 \text{ and } \\ && w_1, e \vDash \exists x \ldotp P \text{ and } w_2, e \vDash \exists x \ldotp Q
\\
