...
\thm (Elementary command soundness). For all $\hat{\mathds{C}} \in \mathsf{ECmd}$, their corresponding axiom $(M_1, \hat{\mathds{C}}, M_2) \in \mathsf{Ax}_{\hat{\mathsf{C}}}$, some $s \in \mathsf{Stack}$, and any given machine state $m \in \mathbb{M}$ the following must hold.
\[
