...
\[
	R^u \triangleq \{ \left( (l, g, \mathcal{J}), (l, g', \mathcal{J}) \right)\ |\ \exists r, \kappa \ldotp \imath(\kappa) = r \land  (l_\mathsf{K} \bullet \llfloor g \rrfloor_\mathsf{K}) \sharp \kappa \land (g, g') \in \lceil \mathcal{J}(r) \rceil (\kappa) \}
\]
