...
From (\ref{tsound:7}) and **LEMMA** we know that there exists a $w' \in \mathsf{World}$ such that:
...
\lem For all $w_1, w_2, w, w' = (l', g', \mathcal{J}') \in \mathsf{World}$,
\[
...
From (\ref{lem:R1}), (\ref{lem:R3}) and by **LEMMAS** we get:
\[
