...
\begin{lem}
	...
	\begin{proof}
		...
		\textit{Base case}: $\pskip \in $
		
		\textit{To show}:
		\[
			\forall h, h', S, S', \Phi, \Phi', \mathds{P} \ldotp
			(h, \Phi, S, \mathds{P}) \rightarrow^0 (h', \Phi', S', \pskip) \implies \Phi' \equiv \emptyset
		\]
		We assume that $(h, \Phi, S, \mathds{P}) \rightarrow^0 (h', \Phi', S', \pskip)$ and know that given the zero-step reduction we have $\mathds{P} = \pskip$ 
	\end{proof}
	}
\end{lem}
