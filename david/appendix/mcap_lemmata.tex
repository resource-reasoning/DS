...
\textit{Coinductive case}: $\mathds{C}_1 ; \mathds{C}_2$
...
\textit{Coinductive case}: $\pif{\mathds{B}}{\mathds{C}_1}{\mathds{C}_2}$
...
\textit{Coinductive case}: $\ploop{\mathds{B}}{\mathds{C}}$
