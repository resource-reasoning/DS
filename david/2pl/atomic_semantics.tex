...
\[\footnotesize\def\arraystretch{3.5}
	\begin{array}{c c}
		...
		{
			(h, \mathds{T}) \tred (h', \mathtt{begin}\ \pskip\ \mathtt{end}_\iota)
		}
		&
		\infer[\textsc{AtPSkip}]
		{
