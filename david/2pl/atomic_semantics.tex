\tocless\subsubsection{Atomic semantics}
...
We only prove the above in the case of $\mathds{T} \in \mathsf{Prog}$ since the rules for programs $\mathds{P} \neq \mathds{T}$ have the same exact structure as the labelled transition system for the operational semantics presented in Views and therefore inherited by mCAP and our transactional instantiation.