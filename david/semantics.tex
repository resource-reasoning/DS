...
\infer[\textsc{Par}]
{
	\vdash (h, \Phi, S, \mathds{T}_1 \| \ldots \| \mathds{T}_\iota \| \ldots \| \mathds{T}_n)
	\rightarrowtail
	(h', \Phi', S', \mathds{T}_1 \| \ldots \| \mathds{T}_\iota' \| \ldots \| \mathds{T}_n)
}
{
	1 \leq \iota \leq n\ \
	\vdash (h, \Phi, S, \mathds{T}_\iota)
...
\infer[\textsc{ParEnd}]
{
	\vdash (h, \Phi, S, \mathds{T}_1 \| \ldots \| \mathtt{begin}\ \pskip\ \mathtt{end}_\iota \| \ldots \| \mathds{T}_n)
	\rightarrowtail
