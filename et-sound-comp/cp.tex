...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \dagger  \equiv 
            \fora{\key, \key', i, j}
                i \in \vi(\key)  \wedge \WTx(\mkvs(\key', j)) \toEDGE{(((\PO \cup \WR_{\mkvs}) ; \AD_{\mkvs}?) \cup \WW_{\mkvs})^{+}} \WTx(\mkvs(\key, i))
            \implies j \in \vi(\key')  
        \end{equation}
...
\dagger  \equiv 
        \fora{\key, \key', m, j}
             m \in \vi(\key)  \wedge \WTx(\mkvs(\key', j)) \toEDGE{(((\PO \cup \WR_{\mkvs}) ; \AD_{\mkvs}?) \cup \WW_{\mkvs})^{+}} \WTx(\mkvs(\key, m))
         \implies j \in \vi(\key')  
\]
...
\begin{gather}
    ...
    \begin{array}{@{}l@{}}
        ...
        \quad {} \land \WTx(\mkvs(\key', j)) \toEDGE{(((\PO \cup \WR_{\mkvs}) ; \AD_{\mkvs}?) \cup \WW_{\mkvs})^{+}} \WTx(\mkvs(\key, m)) \\
