...
\item To prove \cref{equ:cc-sound-update-visvis} is derived from \cref{thm:view-vis-relation}.
    %, let \( \txidset'_\rd = \emptyset \) initially,
...
%\begin{itemize}
    ...
    %\begin{itemize}
        ...
        %because  \( \allowed[\SO \cup \WR_\mkvs] \subseteq \ET_{\CC}\),
        ...
        %\begin{itemize}
            ...
            %this is exactly \( \WFR \) which is a subset of \( \CC \), \ie \( \ET_{\WFR} \subseteq \ET_{\CC}\).
