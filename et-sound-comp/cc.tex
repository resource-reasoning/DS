...
\begin{align*}
    ...
    I_2(\aexec, \cl) & =  \left( \bigcup_{\Setcon{\txid_{\cl}^{n} \in \txidset_{\aexec} }{ n \in \Nat }} (\SO_{\aexec}^{-1})\rflx(\txid^n_\cl) \right) \setminus \txidset_\rd
\end{align*}
...
and \( \left( \bigcup_{\Setcon{\txid_{\cl}^{n} \in \txidset_{\aexec} }{ n \in \Nat }} (\SO_{\aexec}^{-1})\rflx(\txid^n_\cl) \right) \).
