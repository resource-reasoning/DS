...
on the visibility relation of abstract executions, which must be preserved 
must be proved to be preserved by $\ET$-reductions. As we explain in \cref{app:et_sound_complete}, defining the right invariant 
