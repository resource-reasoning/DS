...
but now,  %are labelled with a transaction identifier and the associated fingerprint. 
...
\cite{laws}, and therefore into an equivalent kv-store $\hh_{\aexec}$
...
In the following, we prove the equivalence between the empty set of axioms, corresponding to read atomic, 
