...
Commutativity is a necessary so to swap steps in a trace to match steps in another,
...
an execution-test based specification on kv-stores and views, with respect to the counterpart on abstract executions. 
...
\item for any transaction \( \txid_i \) in \( \aexec \) and the content,
