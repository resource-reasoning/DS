...
%We do this constructively (\cref{sec:kvtrace2aexec},{sec:aexectrace2kv}) which is crucial for proving the soundness and completeness of 
%an execution-test based specification on kv-stores and views, with respect to the counterpart specification using abstract executions. 
