...
where the view of $cl_2$ is the one given in~\ref{Figure1:
  1c}. of~\ref{Figure1}.  It corresponds to what is known in the
literature as \emph{write-conflict freedom}~\cite{.}: the condition
