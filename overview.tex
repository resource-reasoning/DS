...
\subsubsection{General Robustness Results} 
The second application of our operational semantics is to prove
invariant properties such as robustness for client programs with respect to specific consistency models (\cref{sec:robustness}). 
...
we show that the standard lock paradigm is correct under \( \UA \), 
