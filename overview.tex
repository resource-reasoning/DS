...
serialisability.
%described in Section~\ref{.} comes at a significant performance cost.
%
...
%In such replicated settings, concurrent calls to counter operations
%can lead to \emph{weak} behaviours not present under serialisability. 
%
...
modelling the \emph{last writer wins} resolution policy used by several key-value stores~\cite{vogels:2009:ec:1435417.1435432}. 
