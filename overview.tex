...
\end{array}
\]
\sx{I understand the \( \ke_3 \) and \( \ke_4 \) are the flags. 
Is it unnecessary since the read information already in the readers set of the corresponding versions.}
...
\ac{Pictures will need to be drawn: Shale, do you mind doing this? 
