...
We motivate our key ideas, centralised kv-store, partial client views and execution tests,
through a $\mathsf{Counter}(\key)$ example.
We argue that our interleaving semantics is a good middle point to
\begin{enumerate*}
    \item prove invariant properties such as robustness, and 
    \item verify distributed protocols.
\end{enumerate*}
...
develop a proof technique, which we use in \cref{appendix-ref} 
...
than invariant obtained by executing the same programs under serialisability.
