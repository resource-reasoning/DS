...
\[
    \boxass{ \V{x} \pt \stub \sep \V{y} \pt \stub \sep \cass{\CB{x}(\stub)}{\lrid} \sep \cass{\CB{y}(\stub)}{\lrid}}{\lrid}{\intass} 
\]

\[
P1 : \intass :
\begin{rclarray}[t]
    \exsts{\V n} \CB{R} & : & \V{x} \fpR 0 \sep \V{y} \fpW 1 \sep \cass{\CB{x}(\V n)}{\lrid} \fpU \cass{\CB{x}(1)}{\lrid} \\
    \exsts{\V n} \CB{L} & : & \V{x} \fpW 1 \sep \V{y} \fpR 0 \sep \cass{\CB{y}(\V n)}{\lrid} \fpU \cass{\CB{y}(1)}{\lrid} \\
...
\[
\begin{session}
\specline{\boxass{\vx \pt 0 \sep \vy \pt 0 \sep \cass{\CB{x}(0)}{\lrid} \sep \cass{\CB{y}(0)}{\lrid} }{\lrid}{\intass} \sep \cass{\CB{L}}{\lrid} \sep \cass{\CB{R}}{\lrid} } \\
\begin{parl}
\begin{session}
    stable-PL : \specline{\cass{\CB{L}}{\lrid} \sep 
            \boxass{\vx \pt 0 \sep \vy \pt 0 \sep \cass{\CB{x}(0)}{\lrid} \sep \cass{\CB{y}(0)}{\lrid} }{\lrid}{\intass} \lor {} \\
            \boxass{\vx \pt 0 \sep ( \vy \pt 0 \lor \vy \pt 1 ) \sep \cass{\CB{x}(0)}{\lrid} \sep \cass{\CB{y}(1)}{\lrid} }{\lrid}{\intass} 
    } \\
    \begin{transaction}
    ...
    QL : \specline{\cass{\CB{L}}{\lrid} \sep 
            \boxass{\vx \pt 1 \sep \vy \pt 0 \sep \cass{\CB{x}(1)}{\lrid} \sep \cass{\CB{y}(0)}{\lrid} }{\lrid}{\intass} \\
            {} \lor \boxass{\vx \pt 1 \sep \vy \pt 1 \sep \cass{\CB{x}(1)}{\lrid} \sep \cass{\CB{y}(1)}{\lrid} }{\lrid}{\intass} \\
            {} \lor \boxass{\vx \pt 0 \sep \vy \pt 1 \sep \cass{\CB{x}(0)}{\lrid} \sep \cass{\CB{y}(1)}{\lrid} }{\lrid}{\intass} \\
    } \\
    stable-QL : \specline{\cass{\CB{L}}{\lrid} \sep 
            \boxass{\vx \pt 1 \sep \vy \pt 0 \sep \cass{\CB{x}(1)}{\lrid} \sep \cass{\CB{y}(0)}{\lrid} }{\lrid}{\intass} \\
            { \color{purple} {} \lor \boxass{\vx \pt 1 \sep (\vy \pt 0 \lor \vy \pt 1) \sep \cass{\CB{x}(1)}{\lrid} \sep \cass{\CB{y}(1)}{\lrid} }{\lrid}{\intass} } \\
            {} \lor \boxass{\vx \pt 1 \sep \vy \pt 1 \sep \cass{\CB{x}(1)}{\lrid} \sep \cass{\CB{y}(1)}{\lrid} }{\lrid}{\intass} \\
            {} \lor \boxass{\vx \pt 0 \sep \vy \pt 1 \sep \cass{\CB{x}(0)}{\lrid} \sep \cass{\CB{y}(1)}{\lrid} }{\lrid}{\intass} \\
    } \\
\end{session}
...
\begin{session}
    stable-PR : \specline{\cass{\CB{R}}{\lrid} \sep 
            \boxass{\vx \pt 0 \sep \vy \pt 0 \sep \cass{\CB{x}(0)}{\lrid} \sep \cass{\CB{y}(0)}{\lrid} }{\lrid}{\intass} \lor {} \\
            \boxass{ ( \vx \pt 0 \lor \vx \pt 1 ) \sep \vy \pt 0 \sep \cass{\CB{x}(1)}{\lrid} \sep \cass{\CB{y}(0)}{\lrid} }{\lrid}{\intass} 
    } \\
    \begin{transaction}
        \pderef{\pvar{a}}{\vx} ; 
        \quad \pifs{\pvar{a} = 0} 
    ...
    QR : \specline{\cass{\CB{R}}{\lrid} \sep 
            \boxass{\vx \pt 0 \sep \vy \pt 1 \sep \cass{\CB{x}(0)}{\lrid} \sep \cass{\CB{y}(1)}{\lrid} }{\lrid}{\intass} \\
            {} \lor \boxass{\vx \pt 1 \sep \vy \pt 1 \sep \cass{\CB{x}(1)}{\lrid} \sep \cass{\CB{y}(1)}{\lrid} }{\lrid}{\intass} \\
            {} \lor \boxass{\vx \pt 1 \sep \vy \pt 0 \sep \cass{\CB{x}(1)}{\lrid} \sep \cass{\CB{y}(0)}{\lrid} }{\lrid}{\intass} \\
    } \\
    stable-QR : \specline{\cass{\CB{R}}{\lrid} \sep 
            \boxass{\vx \pt 0 \sep \vy \pt 1 \sep \cass{\CB{x}(0)}{\lrid} \sep \cass{\CB{y}(1)}{\lrid} }{\lrid}{\intass} \\
            { \color{purple} {} \lor \boxass{(\vx \pt 0 \lor \vx \pt 1 ) \sep \vy \pt 1 \sep \cass{\CB{x}(1)}{\lrid} \sep \cass{\CB{y}(1)}{\lrid} }{\lrid}{\intass} } \\
            {} \lor \boxass{\vx \pt 1 \sep \vy \pt 1 \sep \cass{\CB{x}(1)}{\lrid} \sep \cass{\CB{y}(1)}{\lrid} }{\lrid}{\intass} \\
            {} \lor \boxass{\vx \pt 1 \sep \vy \pt 0 \sep \cass{\CB{x}(1)}{\lrid} \sep \cass{\CB{y}(0)}{\lrid} }{\lrid}{\intass} \\
    } \\
\end{session}
...
The stable PL and PR rules out those views that cannot progress via any possible transactions.
...
\begin{session}
    stable-PL : \specline{\cass{\CB{L}}{\lrid} \sep 
            \boxass{\vx \pt 0 \sep \cass{\CB{x}(0)}{\lrid} \sep {} \\ \begin{B} \vy \pt 0 \sep \cass{\CB{y}(0)}{\lrid} \\ {} \lor \vy \pt 1 \sep \cass{\CB{y}(1)}{\lrid} \end{B} }{\lrid}{\intass} 
    } \\
...
\begin{session}
    PR : \specline{\cass{\CB{R}}{\lrid} \sep 
            \boxass{ \begin{B} \vx \pt 0  \sep \cass{\CB{x}(0)}{\lrid} \\ {} \lor \vx \pt 1  \sep \cass{\CB{x}(1)}{\lrid} \end{B} \\ {} \sep \vy \pt 0  \sep \cass{\CB{y}(0)}{\lrid} }{\lrid}{\intass} 
    } \\
    \begin{transaction}
        \pderef{\pvar{a}}{\vx} ; 
        \quad \pifs{\pvar{a} = 0} 
