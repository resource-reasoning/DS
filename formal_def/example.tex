...
\begin{parl}
\begin{session}
    P1 : \specline{\cass{\CB{L}}{\lrid} \sep 
    ...
    P2 : \specline{\cass{\CB{L}}{\lrid} \sep 
            \boxass{\vx \pt 0 \sep ( \vy \pt 0 \lor \vy \pt 1 ) }{\lrid}{\intass} 
    } \\
    P3 : \specline{\cass{\CB{L}}{\lrid} \sep 
    ...
    \end{transaction} \\
    Q1: \specline{\cass{\CB{L}}{\lrid} \sep 
    ...
    Q2: \specline{ \cass{\CB{L}}{\lrid}  \sep 
...
\begin{session}
    ...
    \begin{transaction}
        ...
        \pife 
    \end{transaction} \\
    Q1 : \specline{\cass{\CB{R}}{\lrid} \sep 
    ...
    Q2: \specline{ \cass{\CB{R}}{\lrid}  \sep 
               \boxass{\vx \pt 0 \sep \vy \pt 1}{\lrid}{\intass} \lor {} \\
               \boxass{\vx \pt 1 \sep \vy \pt 0}{\lrid}{\intass}
               \lor \boxass{\vx \pt 1 \sep \vy \pt 1}{\lrid}{\intass} } \\
    Q3 : \specline{ 
