...
\sx{The type here is slightly weird, considering \( \lexpr \) has logical variables which is not part of programs }

\azalea{You are right -- I have corrected this.}
...
\sx{  Here is what my understanding.
The first line says a world that is able to collapse down to a TSheap and a time, which is the must important part for prove soundness.
The second line meanings all capabilities must have a corresponding region, which is similar to all other logics.
