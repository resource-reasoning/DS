...
\[
    \infer[\rl{TRDeref}]{%
        \tripleL{ \fp }{ \pderef{\var}{\expr} }{\var \dot= \lexpr \sep \fp' }
    }{%
        \var \notin \func{fv}{\expr}
        && \var \notin \func{fv}{\lexpr}  
...
\[
    \infer[\rl{TRMutate}]{%
        \tripleL{ \fp }{ \pmutate{\expr_1}{\expr_2} }{ \fp' } 
    }{
...
\begin{rclarray}
    ...
    \expr \fpI \anyval & \toFP{\otW(\expr,\lexpr)} & \expr \fpW \lexpr \\
...
\sx{It check the consistency model with respect to one view. Feel a bit strange.}
\begin{defn}[Stable]
