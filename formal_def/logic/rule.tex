...
\[
    \infer[\rl{PRCommit}]{%
        ...
        \begin{array}{c}
        \tripleL{\lpre \sep \emptyset}{\trans}{\lpost \sep \fp}
...
\sx{the allowed predicate might be redundant since we require the pre- and post- conditions are in guarantee and guarantee is  defined with respect to the invariant of a region, and the invariant of a region require similar conditions as the allowed predicate.}
