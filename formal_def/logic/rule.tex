...
\sx{REWORK here , better idea than current horrible def for rely and guarantee.}
...
\sx{This is not correct, it should have two cases, one is history heap get updated, another is my view push to the right}
\begin{defn}[Stable]
