...
\[
\begin{rclarray}    
    \fp, \fp' & ::= & \lexpr \fpR \lexpr \mid \lexpr \fpW \lexpr \mid \lexpr \fpRW (\lexpr, \lexpr) \mid \lexpr \fpI \lexpr \mid \cass{\kap(\vec{\lvar})}{\lrid} \fpA \mid \cass{\kap(\vec{\lvar})}{\lrid} \fpD \mid \fp \sep \fp'
\end{rclarray}
\] 
