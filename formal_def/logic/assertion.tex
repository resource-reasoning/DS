...
\[
\begin{rclarray}    
    \fp, \fp' & ::= & \lexpr \fpR \lexpr \mid \lexpr \fpW \lexpr \mid \lexpr \fpRW (\lexpr, \lexpr) \mid \lexpr \fpI \mid \fpE \mid \cass{\kap(\vec{\lvar})}{\lrid} \fpA \mid \cass{\kap(\vec{\lvar})}{\lrid} \fpD \mid \fp \sep \fp'
\end{rclarray}
\] 
...
\begin{rclarray}
    ...
    \evalF{\lexpr_{1} \fpRW (\lexpr_{2},\lexpr_{3})} & \defeq & \Set{\Set{(\otR, \evalLE{\lexpr_{1}}, \evalLE{\lexpr_{2}}), (\otW, \evalLE{\lexpr_{1}}, \evalLE{\lexpr_{3}})}} \\
