...
\[
\begin{rclarray}
    \inter \in \Interference & \defeq & \Kaps \to \powerset{\powerset{\HisHeaps} \times \Opsets}
\end{rclarray}
\]
...
\begin{rclarray}
    ...
    \begin{cases}
    \left(\Setcon{\hh}{\exsts{\h} \h \in \evalLS[\lenv',\stk]{\bar{\lpre}} \land {} \\ \h = \clpsHH{\hh} }, \evalF[\lenv',\stk]{\fp}\right) \cup \evalI{\intass}(\kap')  & \kap = \kap' \\
