...
\[
    \infer[\rl{TLoopSkip}]{%
        ( \stk, \hp, \rs, \ws ) , \cmd^{*} \ \localtransfer \  ( \stk, \hp, \rs, \ws ) , \pskip
    }{%
    }
\]
...
\[
    \infer[\rl{TLoop}]{%
        ( \stk, \hp, \rs, \ws ) ,  \cmd^{*} \ \localtransfer \  ( \stk, \hp, \rs, \ws ) , \cmd ; \cmd^{*}
    }{%
    }
\]
...
\[
    \infer[\rl{PLoop}]{%
        ( \stk, \tshp, \ts ) , \prog^{*} \ \threadtransfer{\lid} \  ( \stk, \tshp, \ts ) , \prog ; \prog^{*}
    }{%
    }
\]
