...
\begin{proof}
    ...
    Assume \( \eraseAEX{\aexecrun'} \notin \evalCOM{\como} \), so there exists transactions \( \txid' \) , \( \txid'' \) and \( \txid''' \) such that either \( (\txid', \txid'') \in \conguar(\eraseAEX{\aexecrun'}) \land (\txid', \txid'') \notin \aexecrun'\projection{\vis} \) or \( (\etW, \addr, \val) \in \aexecrun'\projection{\tx} \land \val \notin \respo(\eraseAEX{\aexecrun'}, \aexecrun'\projection{\vis}(\tsid'''), \addr) \) for some address \( \addr \) and \( \val \).
    Note that \( \txid' \), \( \txid'' \) and \( \txid''' \) are distinct with the new transaction \( \txid \).

    ......
        
    Therefore we have some transactions \( \txid' \) , \( \txid'' \) and \( \txid''' \) in the abstract execution \( \aexec\), such that either \( (\txid', \txid'') \in \conguar(\eraseAEX{\aexecrun}) \land (\txid', \txid'') \notin \aexecrun\projection{\vis} \) or \( (\etW, \addr, \val) \in \aexecrun\projection{\tx} \land \val \notin \respo(\eraseAEX{\aexecrun}, \aexecrun\projection{\vis}(\tsid'''), \addr) \) for some address \( \addr \) and \( \val \).
    This means \( \eraseAEX{\aexecrun} \notin \evalCOM{\como} \), which contradicts with the hypothesis that \( \eraseAEX{\aexecrun} \in \evalCOM{\como} \).
