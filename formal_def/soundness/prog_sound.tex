...
We now prove for any step in the first trace there exists a corresponding step in the second trace and vice versa.
...
\end{array} 
\]
We now construct a world \( \w'''\) that satisfies the rely \( (\w', \w''') \in \Rely \).
