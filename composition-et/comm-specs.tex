...
\begin{proof}
    ...
    \[
        \fora{j,i, \ke, \ke'} j \leq \vi(\ke) \wedge \WTx(\mkvs'_1(\ke', i)) \xrightarrow{\PO ?} \WTx(\mkvs'_1(\ke, j)) \implies i \leq \vi'(\ke')  \\
    \]
    ...
    \[
        \fora{j,i, \ke} j \leq \vi(\ke) \land \mkvs'_1(\ke, j)\isdef \implies \hh_0(\ke, j)\isdef
    \]
    so we have:
    \[
        \begin{array}{@{}l}
