...
% t0
\node(t0wx) {$(\otW, \ke_1, 1)$}; 
\path (t0wx.east) + (1,0) node (t0wy) {$(\otW, \ke_2, 1)$};
% t1
\path (t0wx.east) + (2.5,0) node[anchor = west] (t1ry) {$(\otW, \ke_1, 2)$}; 
\path (t1ry.east) + (0.2,0) node[anchor = west] (t1wx) {$(\otR, \ke_4, 0)$};
% t2
\path (t0wx.south) + (0,-1.5) node[anchor = north] (t2rx) {$(\otW, \ke_3, 4)$};
\path (t2rx.east) + (0.2,0) node[anchor = west] (t2wy) {$(\otR, \ke_2, 0)$};
% t3
\path (t1ry.south) + (0,-1.5) node[anchor = north] (t3rx) {$(\otW, \ke_3, 3)$};
\path (t3rx.east) + (0.2,0) node[anchor = west] (t3wy) {$(\otW, \ke_4, 1$)};
...
\path[->]
(t0.north) edge[bend left=30] node[above, yshift=3pt, xshift=0pt, pos=0.5] {$\VO$} (t1.north)
...
(t3.south) edge[bend left=30] node[below, yshift=-3pt, xshift=0pt, pos=0.5] {$\VO$} (t2.south);
...
\( \txid_2 \) should see \( \txid_0 \) but \( \txid_2 \) did not read the value 1 for \( \ke_2 \) written by \( \txid_0 \).
