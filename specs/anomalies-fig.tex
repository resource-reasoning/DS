...
\sx{The example above is a counter, why in our framework \( \SI = \CP \cap \UA \) while it holds in abstract execution.
The example ratifies our definition of \( \CP \cap \UA \) but does not satisfies our definition of \( \SI \).}
