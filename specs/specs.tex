...
%            \fora{\ke, \ke', i, j, m, \txid, \txid', \txid''} \\
               \fora{\ke, \ke', i, j} \\
            \begin{array}{@{}l@{}}
            i \in \vi(\ke)  \wedge \WTx(\hh(\ke', j)) \mathrel{((\PO \cup \RF_{\hh} \cup \VO_{\hh}) ; \AD_{\hh}?)} \WTx(\hh(\ke, i))\\
...
%                \right)  \\
      ...
      \ddagger & \equiv &
        \begin{array}[t]{@{}l@{}}
               \fora{\ke, \ke', i, j} \\
            \begin{array}{@{}l@{}}
            i \in \vi(\ke)  \wedge \WTx(\hh(\ke', j)) \mathrel{(((\PO \cup \RF_{\hh}) ; \AD_{\hh}?) \cup \VO_{\hh})} \WTx(\hh(\ke, i))\\
%        \ddagger & \equiv &
%        \begin{array}[t]{@{}l@{}}
%            \fora{\ke, \ke', i, j, m, \txid, \txid', \txid''} \\
%            \left( \begin{array}{@{}l@{}}
