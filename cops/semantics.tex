...
\begin{mathpar}
    ...
    \inferrule[ClientCommit]{%
        \repl, \cl \vdash 
        \mkvsCOPS, \vienvCOPS(\repl), \vienvCOPS(\cl), \stk, \prog(\cl) \toT{\viCL'', \fp}
        \mkvsCOPS', \viREPL', \viCL', \stk', \cmd'
    }{%
        \mkvsCOPS, \vienvCOPS, \thdenv, \prog \toG{\viCL'', \fp}
...
\begin{mathpar}
    \inferrule[sync]{%
        ...
        \mkvsCOPS, \vienvCOPS, \thdenv, \prog \toG{}
...
%\begin{theorem}[COPS satisfy parallel snapshot isolation]
    ...
    %\[
        %\mkvsCOPS'_i, \vienvCOPS'_i, \thdenv'_i, \prog'_i \toG{\viCL',\fp'} \mkvsCOPS'_{i+1}, \vienvCOPS'_{i+1}, \thdenv'_{i+1}, \prog'_{i+1} 
    %\]
