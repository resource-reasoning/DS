...
operationally using graph-based or state-based semantics \cite{sureshConcur,alonetogether,seebelieve,push-pull}.
...
studied \cite{adya,laws,SIanalysis,framework-concur,ev_transactions}. 
...
executions \cite{framework-concur,ev_transactions}. 
...
consistency models \cite{cops,PSI,NMSI}
...
\pg{I am worried about Nagar and Jagannathan. Have they shown that
  ...
  earlier is what we have before. \sx{NO}}
