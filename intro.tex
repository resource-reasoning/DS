...
done on formalising the semantics of such consistency guarantees, both
declaratively as dependancy graphs and abstract execution graphs


 given to 
provide  consistency models for describing  such
guarantees\cite{...nowwhatshouldthecitationsbeev_transactions,framework-concur,consistency3d,seebelieve,laws,alonetogether}. 

generality, declarative, not operational
