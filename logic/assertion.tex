...
Assume two global functions, \( \funcn{init} : \RegionID \to \powerset{ \HisHeaps } \) that returns initial key-value stores for regions.
...
\[
\begin{array}{@{}l}
    \func{init}{\rid} \in \func{inv}{\rid, \intf} \land \fora{\mkvs, \mkvs'} \mkvs \in \func{inv}{\rid, \intf} \exsts{\w, \w'} ( \mkvs, \stub ) = \eraseW{\w} \land ( \mkvs', \stub ) = \eraseW{\w'} \land (\w, \w') \in \Guar \implies \mkvs' \in \func{inv}{\rid, \intf} 
\end{array}
\]
\end{definition}
