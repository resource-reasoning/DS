...
Uet because of \emph{the monotonicity of view} (\cref{lem:mono-view}), the view after update  these the view of the frame will eventually matches with the one of the postcondition.
