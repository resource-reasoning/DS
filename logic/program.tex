...
Those assertions \( \bar{\assfp} \) are interpreted as triples \( ( \assfp, \ca, \ca' ) \) of fingerprints \( \opset \), capabilities that moves into the region \( \ca \) and capabilities that moves out of the region \( \ca' \).
...
Given a interpretation of an action \( (\assfp, \ca_d, \ca_a) \in \evalF[\lenv',\stk]{\bar{\assfp}} \) and any initial state \( (\hh, \vi, \ca_r \composeC \ca_f ) \),
...
\begin{rclarray}
    \evalF{ \assfp } & \defeq &
        \Setcon{(\opset, \ca, \ca')}{
            (\stub,\opset) \in \evalLS{\assfp} \land \ca, \ca' \in \unitC
        }  \\
    ...
    \Setcon{%
        ...
        (\opset_{1}, \ca_{1}, \ca'_{1}) \in \evalF{\assfp_{1}}  \land{} \\ \quad  (\opset_{2}, \ca_{2}, \ca'_{2}) \in \evalF{\assfp_{2}}
    }\\
    	...
    	\qquad \left\{ 
            ...
            \multicolumn{2}{@{}l@{}}{
                    \Setcon{
                        ...
                        ( \opset, \ca_{a}, \ca_{r} ) \in \evalF[\lenv',\stk]{\assfp} \\
