...
\[
\begin{rclarray}
    \pred{readFrom}{\mkvs, \vi, \fp} & \defeq & \fora{\ke, \val} (\otR, \ke, \val) \in \fp \implies \snapshot(\mkvs,\vi)(\ke) = \val
\end{rclarray}
\]
\end{definition}
...
\begin{rclarray}
    ...
    \evalAUX{\lexpr_{1} \pt \lexpr_2} & \defeq & \Setcon{ (\mkvs, \vi, \ca) }{ \Set{ \evalLE{\lexpr_{1}} \mapsto \evalLE{\lexpr_{2}} } = \clpsHH{\mkvs, \vi} \land \ca \in \unitC } \\
