...
The \( \pred{up} \) predicate says the post-condition \( \gpost \) is the result by lifting the local fingerprints \( \fp \) to pre-condition \( \gpre \).
...
\begin{rclarray}
    ...
    \begin{array}[t]{@{}l@{}}
        ...
        \land \func{reachable}{\aexec, \aexec', \stub, \evalF{\fp}, \ET}  \\
